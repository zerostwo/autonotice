...
def log_scau(id, pwd, r):
    ...
    try:
        ...
        log = open('/root/auto_task/notice/auto_notice.log', "a+")
        ...
        # 获取本地上的信息
        info_set = []
        info_file = open('/root/auto_task/notice/info.txt')
        while True:
        ...
        if len(compare) == 0:
            ...
            info_file = open('/root/auto_task/notice/info.txt', "a+")
...
r = []
user_file = open('/root/auto_task/notice/user.txt')
while True:
